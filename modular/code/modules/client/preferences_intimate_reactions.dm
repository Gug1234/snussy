 ...
 * under the key "custom_intimate_reactions_json".
 *
...
/datum/preferences
	 ...
	 * Serialized to JSON for savefile persistence (key: "custom_intimate_reactions_json").
	 */
	var/list/custom_intimate_reactions = null
