...
/obj/item/rogueweapon/trickweapon/simonsbowblade
	...
	transform_sound = 'modular/sounds/trickweapons/simonsbowblade/bow_transform.ogg'
	untransform_sound = list('modular/sounds/trickweapons/simonsbowblade/bow_untransform1.ogg', 'modular/sounds/trickweapons/simonsbowblade/bow_untransform2.ogg')
	throwforce = 8
...
/obj/item/rogueweapon/trickweapon/simonsbowblade/getonmobprop(tag)
	...
	if(tag)
		if(transformed)
			switch(tag)
				if("gen")
					return list("shrink" = 0.7,"sx" = -3,"sy" = 1,"nx" = 2,"ny" = 0,"wx" = 3,"wy" = 2,"ex" = -3,"ey" = 2,"northabove" = 1,"southabove" = 0,"eastabove" = 1,"westabove" = 0,"nturn" = 6,"sturn" = 166,"wturn" = 166,"eturn" = 36,"nflip" = 0,"sflip" = 1,"wflip" = 1,"eflip" = 0)
				if("wielded")
					return list("shrink" = 0.75,"sx" = -5,"sy" = -2,"nx" = 0,"ny" = -1,"wx" = -4,"wy" = -1,"ex" = -5,"ey" = -1,"northabove" = 0,"southabove" = 1,"eastabove" = 1,"westabove" = 1,"nturn" = 186,"sturn" = 2,"wturn" = 48,"eturn" = 4,"nflip" = 1,"sflip" = 0,"wflip" = 0,"eflip" = 0)
		else
			switch(tag)
				if("gen")
					return list("shrink" = 0.6,"sx" = -15,"sy" = -12,"nx" = 15,"ny" = -12,"wx" = -11,"wy" = -10,"ex" = 6,"ey" = -12,"northabove" = 1,"southabove" = 0,"eastabove" = 1,"westabove" = 0,"nturn" = 90,"sturn" = 90,"wturn" = 90,"eturn" = 91,"nflip" = 0,"sflip" = 1,"wflip" = 1,"eflip" = 0)
				if("wielded")
					return list("shrink" = 0.6,"sx" = 7,"sy" = -4,"nx" = -12,"ny" = -3,"wx" = 7,"wy" = -7,"ex" = 13,"ey" = -2,"northabove" = 0,"southabove" = 1,"eastabove" = 1,"westabove" = 1,"nturn" = 182,"sturn" = 1,"wturn" = 20,"eturn" = 1,"nflip" = 1,"sflip" = 0,"wflip" = 0,"eflip" = 0)
