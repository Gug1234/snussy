...
/obj/item/rogueweapon/trickweapon/huntersaif/getonmobprop(tag)
	...
	if(tag)
		if(transformed)
			switch(tag)
				if("gen")
					return list("shrink" = 0.55,"sx" = -11,"sy" = -9,"nx" = 11,"ny" = -11,"wx" = -7,"wy" = -7,"ex" = 6,"ey" = -11,"northabove" = 1,"southabove" = 0,"eastabove" = 1,"westabove" = 0,"nturn" = 90,"sturn" = 90,"wturn" = 102,"eturn" = 81,"nflip" = 0,"sflip" = 1,"wflip" = 1,"eflip" = 0)
				if("wielded")
					return list("shrink" = 0.7,"sx" = 13,"sy" = -1,"nx" = -15,"ny" = -2,"wx" = 12,"wy" = -3,"ex" = 12,"ey" = 3,"northabove" = 0,"southabove" = 1,"eastabove" = 1,"westabove" = 1,"nturn" = 148,"sturn" = 22,"wturn" = 30,"eturn" = 4,"nflip" = 1,"sflip" = 0,"wflip" = 0,"eflip" = 0)
		else
			switch(tag)
				if("gen")
					return list("shrink" = 0.35,"sx" = -7,"sy" = -6,"nx" = 5,"ny" = -6,"wx" = -5,"wy" = -6,"ex" = -4,"ey" = -5,"northabove" = 1,"southabove" = 0,"eastabove" = 1,"westabove" = 0,"nturn" = 90,"sturn" = 90,"wturn" = 90,"eturn" = 90,"nflip" = 0,"sflip" = 1,"wflip" = 1,"eflip" = 0)
				if("wielded")
					return list("shrink" = 0.45,"sx" = 1,"sy" = -3,"nx" = -3,"ny" = -3,"wx" = -1,"wy" = -3,"ex" = 3,"ey" = -1,"northabove" = 0,"southabove" = 1,"eastabove" = 1,"westabove" = 1,"nturn" = 148,"sturn" = 30,"wturn" = 45,"eturn" = 0,"nflip" = 1,"sflip" = 0,"wflip" = 0,"eflip" = 0)
