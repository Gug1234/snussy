...
/obj/item/rogueweapon/trickweapon/rakuyo
	...
	transform_sound = list('modular/sounds/trickweapons/rakuyo/rakuyo_transform1.ogg', 'modular/sounds/trickweapons/rakuyo/rakuyo_transform2.ogg')
	untransform_sound = list('modular/sounds/trickweapons/rakuyo/rakuyo_untransform1.ogg', 'modular/sounds/trickweapons/rakuyo/rakuyo_untransform2.ogg')
	throwforce = 10
...
/obj/item/rogueweapon/trickweapon/rakuyo/getonmobprop(tag)
	...
	if(tag)
		if(transformed)
			...
			switch(tag)
				if("gen")
					return list("shrink" = 0.7,"sx" = -10,"sy" = -7,"nx" = 9,"ny" = -5,"wx" = -5,"wy" = -5,"ex" = 2,"ey" = -4,"northabove" = 1,"southabove" = 0,"eastabove" = 1,"westabove" = 0,"nturn" = 90,"sturn" = 90,"wturn" = 108,"eturn" = 63,"nflip" = 0,"sflip" = 1,"wflip" = 1,"eflip" = 0)
				if("wielded")
					return list("shrink" = 0.85,"sx" = 4,"sy" = -1,"nx" = -7,"ny" = 0,"wx" = 7,"wy" = -2,"ex" = 5,"ey" = 3,"northabove" = 0,"southabove" = 1,"eastabove" = 1,"westabove" = 1,"nturn" = 145,"sturn" = 44,"wturn" = 45,"eturn" = 0,"nflip" = 1,"sflip" = 0,"wflip" = 0,"eflip" = 0)
