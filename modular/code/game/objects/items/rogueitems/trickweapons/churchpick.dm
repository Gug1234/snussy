...
/obj/item/rogueweapon/trickweapon/churchpick/getonmobprop(tag)
	...
	if(tag)
		if(transformed)
			switch(tag)
				if("gen")
					return list("shrink" = 0.65,"sx" = -4,"sy" = -5,"nx" = 8,"ny" = -8,"wx" = -3,"wy" = 4,"ex" = 0,"ey" = 4,"northabove" = 1,"southabove" = 0,"eastabove" = 1,"westabove" = 0,"nturn" = 90,"sturn" = 90,"wturn" = 252,"eturn" = 300,"nflip" = 0,"sflip" = 1,"wflip" = 1,"eflip" = 0)
				if("wielded")
					return list("shrink" = 0.65,"sx" = 2,"sy" = -1,"nx" = -8,"ny" = 0,"wx" = 5,"wy" = -2,"ex" = 5,"ey" = 1,"northabove" = 0,"southabove" = 1,"eastabove" = 1,"westabove" = 1,"nturn" = 189,"sturn" = -10,"wturn" = 15,"eturn" = -10,"nflip" = 1,"sflip" = 0,"wflip" = 0,"eflip" = 0)
		else
			switch(tag)
				if("gen")
					return list("shrink" = 0.5,"sx" = -12,"sy" = -7,"nx" = 10,"ny" = -8,"wx" = -10,"wy" = -6,"ex" = 3,"ey" = -7,"northabove" = 1,"southabove" = 0,"eastabove" = 1,"westabove" = 0,"nturn" = 84,"sturn" = 110,"wturn" = 112,"eturn" = 70,"nflip" = 0,"sflip" = 1,"wflip" = 1,"eflip" = 0)
				if("wielded")
