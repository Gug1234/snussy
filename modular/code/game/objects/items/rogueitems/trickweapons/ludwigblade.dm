...
/obj/item/rogueweapon/trickweapon/ludwigblade
	...
	transform_sound = list('modular/sounds/trickweapons/ludwigblade/ludwig_transform1.ogg', 'modular/sounds/trickweapons/ludwigblade/ludwig_transform2.ogg')
	untransform_sound = list('modular/sounds/trickweapons/ludwigblade/ludwig_untransform1.ogg', 'modular/sounds/trickweapons/ludwigblade/ludwig_untransform2.ogg')
	throwforce = 10
...
/obj/item/rogueweapon/trickweapon/ludwigblade/getonmobprop(tag)
	...
	if(tag)
		if(transformed)
			switch(tag)
				if("gen")
					return list("shrink" = 0.55,"sx" = -18,"sy" = -15,"nx" = 15,"ny" = -14,"wx" = 5,"wy" = 10,"ex" = -7,"ey" = 9,"northabove" = 0,"southabove" = 1,"eastabove" = 1,"westabove" = 0,"nturn" = 90,"sturn" = 176,"wturn" = -11,"eturn" = 283,"nflip" = 0,"sflip" = 0,"wflip" = 0,"eflip" = 0)
				if("wielded")
					return list("shrink" = 0.7,"sx" = 9,"sy" = 2,"nx" = -9,"ny" = 2,"wx" = 11,"wy" = -11,"ex" = 11,"ey" = 5,"northabove" = 0,"southabove" = 1,"eastabove" = 1,"westabove" = 1,"nturn" = 181,"sturn" = 1,"wturn" = 51,"eturn" = -15,"nflip" = 1,"sflip" = 0,"wflip" = 0,"eflip" = 0)
		else
			switch(tag)
				if("gen")
