...
/datum/sex_action/chastityplay/sounding_cock_cage/proc/target_has_sounding_rod(mob/living/carbon/human/target)
	return istype(target?.intimate_genital_insertable, /obj/item/intimate_accessory/genital/plug/sounding_rod)
