...
/proc/apply_character_post_equipment(mob/living/carbon/human/character, client/player)
	...
	player.prefs.apply_intimate_preferences(character)
	player.prefs.apply_cursed_collar_preferences(character)
	if(!player.prefs.uses_cursed_roundstart_chastity())
		player.prefs.apply_chastity_preferences(character)
