...
// ── Removed verbs ────────────────────────────────────────────────────────────
// The following verbs were removed because they are now fully handled by the
// consolidated ERP Preferences menu (see erp_preferences_menu.dm):
//   toggle_ERP, toggle_Chastity, toggle_Chastity_Hardmode,
//   toggle_extreme_ERP, toggle_edging
// The modular_handle_chastity_toggle_disable and modular_handle_extreme_erp_toggle_disable
// callbacks are still invoked from the ERP menu's Topic handler.
