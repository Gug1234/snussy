...
/proc/build_cool_description(list/descriptors, mob/living/described, mob/watcher = null)
	var/list/lines = list()
	var/list/desc_copy = descriptors.Copy()
...
/proc/build_cool_description_unknown(list/descriptors, mob/living/described, mob/watcher = null)
	var/list/lines = list()
	var/list/desc_copy = descriptors.Copy()
...
/proc/build_coalesce_description(list/descriptors, mob/living/described, list/slots, string, mob/watcher = null)
