...
#define GILDED_CHASTITY_OVERDRAW_STRIP "strip"

#define GILDED_CHASTITY_FORCED_MESSAGE_SAY "say"
#define GILDED_CHASTITY_FORCED_MESSAGE_ME "me"
#define GILDED_CHASTITY_MAX_FORCED_MESSAGES 3
