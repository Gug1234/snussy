...
#define TRAIT_BEAST_DRUNK "Beast Drunk"
#define TRAIT_FORCED_CMODE "Forced Combat Mode"
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_BEAST_DRUNK = span_warning("The old blood clouds my vision. Sometimes, everyone around me starts to look like beasts."),
