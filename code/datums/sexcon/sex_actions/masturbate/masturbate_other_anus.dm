...
/// Tease another person's worn butt plug — subtle-aware, uses can/target helpers from toy_helpers.
...
/// Repeatedly pull out and thrust another person's butt plug back in — high arousal, penetration category.
