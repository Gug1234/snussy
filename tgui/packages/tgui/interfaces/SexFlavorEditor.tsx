        ...
        <Stack wrap align="center" mt={0.5}>
          ...
          <Stack.Item mr={1}>
            ...
            <Button
              ...
              onClick={() =>
                update({ req_target_jelly: !action.req_target_jelly })
              }
            >
            ...
            <Stack.Item>
              <Section title="Import Data">
                <Box fontSize="11px" opacity={0.7} mb={1}>
                  Paste an exported data string below and click
                  &quot;Import&quot; to replace your current flavor text and
                  custom actions. <b>This overwrites existing data</b> — export
